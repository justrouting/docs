...
```
GET https://api.justrouting.tech/osrm/nearest/v1/{profile}/{coordinates}
```
...
```bash
curl "https://api.justrouting.tech/osrm/nearest/v1/driving/103.708362,1.357371?number=2" \
