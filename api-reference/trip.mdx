...
```
GET https://api.justrouting.tech/osrm/trip/v1/{profile}/{coordinates}
```
...
curl "https://api.justrouting.tech/osrm/trip/v1/driving/103.708362,1.357371;103.8514,1.2897;103.82324228,1.32408622;103.78432387,1.31490148;103.984748,1.352212?roundtrip=false&source=first&geometries=geojson" \
