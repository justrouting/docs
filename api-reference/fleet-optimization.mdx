...
There are also `shipments` (pickup-then-delivery pairs) and more advanced fields — the full schema is in the **OpenAPI → optimize** section (auto-generated three-panel pages).
